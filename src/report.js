...
if (ipAddr.includes(":")) {
    document.getElementById("ip-report")
        .classList.add("border-purple", "text-white")
    document.getElementById("ip-report-title")
    ...
    document.getElementById("ip-report")
        .classList.add("border-yellow")
    document.getElementById("ip-report-title")
        .classList.add("bg-yellow", "text-black")
    document.getElementById("emoji")
        .innerHTML = "🤔"
    document.getElementById("message")
        .innerHTML = "We could not reliably determine your IP."
    document.getElementById("wall-of-text")
        .innerHTML = ""
};